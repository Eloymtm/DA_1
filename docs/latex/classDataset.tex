...
\begin{center}
\leavevmode
\includegraphics[width=176pt]{classDataset__coll__graph}
\end{center}
\end{figure}
...
\item 
double \mbox{\hyperlink{classDataset_ab582c6c799c43e34cc0e38e552222907}{max\+Flow}} ()
\item 
...
This function adds a vertex \char`\"{}\+Super\+Source\char`\"{} to the graph and adds all edges between the \char`\"{}\+Super\+Source\char`\"{} and all reservoirs of the graph with origin on \char`\"{}\+Super\+Source\char`\"{} \mbox{\Hypertarget{classDataset_ab582c6c799c43e34cc0e38e552222907}\label{classDataset_ab582c6c799c43e34cc0e38e552222907}} 
\index{Dataset@{Dataset}!maxFlow@{maxFlow}}
\index{maxFlow@{maxFlow}!Dataset@{Dataset}}
\doxysubsubsection{\texorpdfstring{maxFlow()}{maxFlow()}}
{\footnotesize\ttfamily double Dataset\+::max\+Flow (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}

Calculates maximum flow through the map city\+Max\+Flow\+Original\+Graph that belongs to the class \mbox{\hyperlink{classDataset}{Dataset}}. ~\newline
 Time Complexity\+: O(n) \begin{DoxyReturn}{Returns}
the maximum flow in the network 
\end{DoxyReturn}
\mbox{\Hypertarget{classDataset_a7215bcf13b2d6eca71442f61ea4feabe}\label{classDataset_a7215bcf13b2d6eca71442f61ea4feabe}} 
...
\item 
classes/Dataset.\+h\item 
classes/Dataset.\+cpp\end{DoxyCompactItemize}
